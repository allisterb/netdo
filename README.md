...
## Donna
Donna is an AI agent for efficiently monitoring and managing DigitalOcean IaaS and PaaS resources by generating executable code that orchestrates multiple API operations in a sandboxed, constrained environment 
